...
import { colors, bodypartBaseData, compoundEffects } from "./settings"
 ...
 * @param notify 是否发送邮件
 */
export function log(content: string, prefixes: string[] = [], color: Colors | null = null, notify: boolean = false): OK {
	// 有前缀就组装在一起
